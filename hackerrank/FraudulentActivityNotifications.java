...
public class FraudulentActivityNotifications {
   ...
   * 1. I traverse the spendings list from spendings.get(trailingDays) to the end of the list.
   * 2. In every iteration of the for loop (Step 1), I sort a subList of size equal to trailingDays.
   */
